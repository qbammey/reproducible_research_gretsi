...
Quentin Bammey (EPFL, IVRL)

Gabriele Facciolo (ENS Paris-Saclay, Centre Borelli, IUF)

Adrien Krähenbühl (Unistra, ICube)

</small>

![](images/epfl.svg){height="28"} ![](images/ivrl.png){height="35"} ![](images/ens.png){height="30"} ![](images/cgb.png){height="35"} ![](images/iuf.png){height="35"} ![](images/unistra.png){height="35"} ![](images/icube.png){height="30"}
...
![](images/thisisfine.png){fig-align="center" width="400"}
...
- Cleanup code (LINT) for readability 
...
[![](images/huggingface_fail.jpg){width=100%}](https://github.com/advimman/lama?tab=readme-ov-file#-lama-resolution-robust-large-mask-inpainting-with-fourier-convolutions)
...
* Designing clean, reproducible, and easy-to-use implementations helps **build trust** and **maximize impact**.
