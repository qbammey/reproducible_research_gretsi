...
**Quentin Bammey (EPFL, IVRL), Gabriele Facciolo (ENS Paris-Saclay, Centre Borelli, Institut Universitaire de France), Adrien Krähenbühl (Unistra, ICube)**

![](images/epfl.svg){height="30"} ![](images/ivrl.png){height="30"} ![](images/ens.png){height="30"} ![](images/cgb.png){height="30"} ![](images/iuf.png){height="30"} ![](images/unistra.png){height="30"} ![](images/icube.png){height="30"}
